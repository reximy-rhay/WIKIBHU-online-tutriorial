                            ...
                            <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasNavbar" aria-labelledby="offcanvasNavbarLabel">
                                ...
                                <div class="offcanvas-body">
                                    <ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
                                        <li class="nav-item">
                                            <a class="nav-link active" aria-current="page" href="./index.php"><i class="uil uil-home"></i>Home</a>
                                        </li>
            ...
            <div class="col-sm-6">
                <div class="card">
                    <div class="card-body">
                        ...
                        <p class="card-text">100 Level Past Questions and Answers.</p>
                        <a href="./100level.html" class="btn btn-success">Confirm-active</a>
                    </div>
                </div>
            </div>
            <div class="col-sm-6">
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">Practice Questions</h5>
                        <p class="card-text">200 Level Past Questions and Answers.</p>
        ...
        <div class="row">
            <div class="col-sm-6">
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">Practice Questions</h5>
                        <p class="card-text">300 Level Past Questions and Answers.</p>
                        <a href="" class="btn btn-danger">Confirm</a>
                    </div>
                </div>
            </div>
            <div class="col-sm-6">
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">Practice Questions</h5>
                        <p class="card-text">400 Level Past Questions and Answers.</p>
                        <a href=""class="btn btn-danger">Confirm</a>
                    </div>
                </div>
            </div>
        ...
        <div class="row">
            <div class="col-sm-6">
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">Practice Questions</h5>
                        <p class="card-text">500 Level Past Questions and Answers.</p>
                        <a href=""class="btn btn-danger">Confirm</a>
                    </div>
                </div>
            </div>
            <div class="col-sm-6">
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">Practice Questions</h5>
                        <p class="card-text">600 Level Past Questions and Answers.</p>
                        <a href=""class="btn btn-danger">Confirm</a>
                    </div>
                </div>
            </div>
    ...
    <footer id="dk-footer" class="dk-footer">
        ...
        <div class="copyright">
            <div class="container">
                <div class="row">
                    <div class="col-md-6">
                        <span>Copyright © 2022, All Right Reserved reximy</span>
                    </div>
                    <!-- End Col -->
                    <div class="col-md-6">
                        <div class="copyright-menu">
                            <ul>
                                <li>
                                    <a href="../project3/OnePage/index.html">Home</a>
                                </li>
